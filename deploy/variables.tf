...
variable "other_revision_suffix" {
  type        = string
  default     = ""
  description = "Revision suffix for the isolated jobops-other Container App."
}

variable "other_basic_auth_user" {
  type        = string
  default     = "admin"
  description = "Basic-auth username for jobops-other. The password is generated by Terraform."
}
